...
| 2.3.3 | May switch to **bf16** and/or `torch.compile` / CUDA graphs for the timed run (numerics-changing tricks allowed here; correctness is checked on the fp32 path). | n/a |
